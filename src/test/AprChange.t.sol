...
contract AprChangeTest is Setup {
    ...
    function test_checkAaveAprChange(
        uint256 _amount,
        ...
        (uint256 currentAprSupply, uint256 currentApyBorrow) = strategy
            .aaveRates(0);
        ...
        (uint256 negativeAprSupply, uint256 negativeApyBorrow) = strategy
            .aaveRates(-int256(_delta));
        ...
        (uint256 possitveAprSupply, uint256 positiveApyBorrow) = strategy
            .aaveRates(int256(_delta));
